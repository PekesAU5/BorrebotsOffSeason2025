...
public static class armConstants{
  ...
  public static final int karmMotorId = 3;

  public static final double kMaxVoltage = 8.0;
  public static final double kMinVoltage = -8.0;



public static final double L1 = 0.0;
  public static final double L2 = 0.0;
  public static final double L3 = 170.0;
  public static final double L4 = 177.0;

  public static final double CORALSTATION = 0.0;

  public static final double REEFALGAE =
   90.0;
  
  public static final double PROCESSOR = 30.0;

  public static final double NET = 170.0;
  ...
  public static double kMaxAngularVelocity = 775.0;
  public static double kMaxAngularAccelearion = 232.502;


  public static final double kMotorGearing = 125.0;
  public static final double kAngleFactor = 360 / 125.0;  

  public static final double forwardAngleLimit = 220.0;
  public static final double reverseAngleLimit = 0.0;

  public static final double armVelocityFF =  1/  ((NeoMotorConstants.kFreeSpeedRpm / 60) / kMotorGearing);

  public static final double kAllowableErrorpercent = 0.03;
...
public static final class Elevator{
  ...
  public static final double L1 = 1.18;
  public static final double L2 = 1.40; //la posición oficial es 31.875in
  public static final double L3 = 1.12; //la posición oficial es 47.625in
  public static final double L4 = 1.74;

  public static final double CORALSTATION = 1.58;

  

  public static final double LOWALGAE = 1.30;
  public static final double HIGHALGAE = 1.50;

  public static final double NET = 1.64;
  public static final double PROCESSOR = 1.10;

  public static final double kAllowableErrorHeight = 0.05;

  public static final double kunextendedElevatorHeightMeters  = 1.03;
  public static final double LowPOS = kunextendedElevatorHeightMeters;
  public static final double MINheight = kunextendedElevatorHeightMeters+0.07;
  public static final double MAXheight = 0.75 + kunextendedElevatorHeightMeters;
  ...
  public static final double MAX_VEL_M_S = 2.0; // m/s Si el elevador tiembla o se pasa, baja
  public static final double MAX_ACCEL_M_S2 = 0.666; // m/s^2 Si se siente muy lento y sobrado, sube
  ...
  public static final double MIN_OUTPUT = -0.6; // limitar descenso
...
public static final double yReefSetpoint =  -15;
=======
...
public static final double yReefSetpoint =  10;
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
public static final double xAlgaeSetpoint = 0.0;
=======
public static final double xAlgaeSetpoint = 0;
>>>>>>> Stashed changes
...
public static final String LEFTALLIGN = "left";
public static final String RIGHTALLIGN = "right";
public static final String ALGAEALLIGN = "algae";
...
public static final class OIConstants {
  ...
  public static boolean kAlgaeMode = false;
